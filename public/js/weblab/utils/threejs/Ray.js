...
THREE.Ray = function ( origin, direction ) {
	...
	this.intersectObjects = function ( objects, aDistance ) {
		...
		for ( i = 0, l = objects.length; i < l; i ++ ) {
			...
			Array.prototype.push.apply( intersects, this.intersectObject( objects[ i ], aDistance ) );
	...
	this.intersectObject = function ( object, aDistance ) {
