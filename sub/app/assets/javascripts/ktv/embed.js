...
((function () {
    ...
    a = function () {
        function f(a, b) {
            var c;
            this.element = a, this.params = b, this.keyup = d(this.keyup, this), this.resize = d(this.resize, this), this.container = this.element.parentNode, this.course_slug = this.element.getAttribute("data-course-slug"), this.courseware_slug = this.element.getAttribute("data-courseware-slug"),this.cw_revision = this.element.getAttribute("data-cw-revision"), this.ratio = this.element.getAttribute("data-ratio") || 4 / 3, (c = this.params) == null && (this.params = {}), this.params.slide = this.element.getAttribute("data-slide")
        }
        var a = this;
        return f.init = function () {
          ...
          if (this.cw_revision) {
            return "/embed/" + this.courseware_slug + "/revisions/" + this.cw_revision + "?" + this.toParam();
          }else{
