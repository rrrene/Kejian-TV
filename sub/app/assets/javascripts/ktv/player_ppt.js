...
(function (a, b) {
  ...
  function G(a, c, d) {
    if (d === b && a.nodeType === 1) {
      var e = "data-" + c.replace(O, "$1-$2").toLowerCase();
      d = a.getAttribute(e);
      if (typeof d == "string") {
        try {
  ...
  K.event = {
    ...
    trigger: function (c, d, e, f) {
      ...
      if ( !! e && !K.event.customEvent[g] || !! K.event.global[g]) {
        c = typeof c == "object" ? c[K.expando] ? c : new K.Event(g, c) : new
        K.Event(g), c.type = g, c.exclusive = i, c.namespace = h.join("."), c.namespace_re = new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.)?") + "(\\.|$)");
  ...
  var h = "2.0.6",
    ...
    j = !0,
    k = b.documentElement,
    l = b.head || b.getElementsByTagName("head")[0],
    m = "modernizr",
    n = b.createElement(m),
    o = n.style,
    p, q = Object.prototype.toString,
    ...
    w = function (a, c, d, e) {
      ...
      if (parseInt(d, 10)) while (d--) h = b.createElement("div"), h.id = e ? e[d] : m + (d + 1), i.appendChild(h);
      return f = ["&shy;", "<style>", a, "</style>"].join(""), i.id = m, i.innerHTML += f, k.appendChild(i), g = c(i, a), i.parentNode.removeChild(i), !! g
    },
    x = function (b) {
      if (a.matchMedia) return matchMedia(b).matches;
      var c;
      return w("@media " + b + " { #" + m + " { position: absolute; } }", function (b) {
        c = (a.getComputedStyle ? getComputedStyle(b, null) : b.currentStyle).position == "absolute"
      }), c
    },
    y, z = {}.hasOwnProperty,
    A;
  !e(z, c) && !e(z.call, c) ? A = function (a, b) {
    return z.call(a, b)
  } : A = function (a, b) {
    return b in a && e(a.constructor.prototype[b], c)
  };
  var B = function (c, d) {
      var e = c.join(""),
        f = d.length;
      w(e, function (c, d) {
        var e = b.styleSheets[b.styleSheets.length - 1],
          g = e.cssRules && e.cssRules[0] ? e.cssRules[0].cssText : e.cssText || "",
          h = c.childNodes,
          j = {};
        while (f--) j[h[f].id] = h[f];
        i.touch = "ontouchstart" in a || j.touch.offsetTop === 9
      }, f, d)
    }([, ["@media (", r.join("touch-enabled),("), m, ")", "{#touch{top:9px;position:absolute}}"].join("")], [, "touch"]);
  s.touch = function () {
    return i.touch
  };
  for (var C in s) A(s, C) && (y = C.toLowerCase(), i[y] = s[C](), v.push((i[y] ? "" : "no-") + y));
  return g(""), n = p = null, a.attachEvent &&
  function () {
  ...
  function (a, b) {
    ...
    }, d(b), d(m), e.disablePP || (o.insertBefore(q, o.firstChild), q.media = "print", q.className = "iepp-printshim", a.attachEvent("onbeforeprint", e._beforePrint), a.attachEvent("onafterprint", e._afterPrint))
  }(a, b), i._version = h, i._prefixes = r, i.mq = x, i.testStyles = w, k.className = k.className.replace(/\bno-js\b/, "") + (j ? " js " + v.join(" ") : ""), i
  ...
  a = function () {
    function a() {
      this.receive = b(this.receive, this), jQuery(window).bind("message", this.receive), this.pending = []
    }
    return a.prototype.receive = function (a) {
      var b, c;
      return this.window || (this.window = a.originalEvent.source, this.sendPending()), b = JSON.parse(a.originalEvent.data), (c = jQuery(this)).trigger.apply(c, b)
    }, a.prototype.trigger = function () {
      var a;
      return a = 1 <= arguments.length ? c.call(arguments, 0) : [], this.window ? this.window.postMessage(JSON.stringify(a), "*") : this.pending.push(a)
    }, a.prototype.sendPending = function () {
      var a, b;
      b = [];
      while (a = this.pending.shift()) b.push(this.trigger.apply(this, a));
      return b
    }, a.prototype.bind = function () {
      var a, b;
      return a = 1 <= arguments.length ? c.call(arguments, 0) : [], (b = jQuery(this)).bind.apply(b, a)
    }, a
  }(), this.FrameChannel = a
}.call(this), function () {
  var a, b = function (a, b) {
  ...
  a = function () {
    function a() {
      this.goToSlide = b(this.goToSlide, this), this.previousSlide = b(this.previousSlide, this), this.nextSlide = b(this.nextSlide, this), this.channel = new FrameChannel, this.setup()
    }
    return a.prototype.setup = function () {
      return this.channel.bind("nextSlide", this.nextSlide), this.channel.bind("previousSlide", this.previousSlide), this.channel.bind("goToSlide", this.goToSlide)
    }, a.prototype.nextSlide = function () {
      return Slide.next()
    }, a.prototype.previousSlide = function () {
      return Slide.previous()
    }, a.prototype.goToSlide = function (a, b) {
      return Slide.goToSlide(b)
    }, a
  }(), this.Player = a
}.call(this)