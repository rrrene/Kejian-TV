...
FlashDetect.JS_RELEASE = "1.0.4", function (a, b) {function c(b, c) {
  ...
  // jquery.ui.datepicker
        ...
        return a && (jQuery.browser.safari && typeof a == "object" && a.length || a.constructor && a.constructor.toString().match(/\Array\(\)/))
    }
    $.extend($.ui, {
        datepicker: {
            version: "1.8.20"
    ...
    $.extend(Datepicker.prototype, {
        ...
        _showDatepicker: function (a) {
            ...
            }), e && jQuery.browser.opera && ($.datepicker._pos[0] -= document.documentElement.scrollLeft, $.datepicker._pos[1] -= document.documentElement.scrollTop);
            var f = {
        ...
        _generateHTML: function (a) {
            ...
            return K += x + (jQuery.browser.msie && parseInt(jQuery.browser.version, 10) < 7 && !a.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""), a._keyEvent = !1, K
        },
    ...
    c = function () {function a(a) {
        ...
        return e(a, c), a.prototype.setup = function () {
            ...
            return this.form.find('input[name="presentation[id]"]').remove(), a = {
                ...
                allowedExtensions: ["pdf",'djvu','ppt','pptx','doc','docx','zip','rar'],
        ...
        return e(a, c), a.prototype.setup = function () {
            ...
            return $("#uploader",'.__sdk').append('<div class="qq-uploader">        <div class="qq-upload-button">          <span class="button primary select">选择要上传的文件</span>          <span class="button primary cancel">文件已选定</span>        </div>        <ul class="qq-upload-list"></ul>      </div>'), $("#presentation_pdf",'.__sdk').uploadify({
                ...
                fileExt: "*.pdf; *.djvu; *.ppt; *.pptx; *.doc; *.docx; *.zip; *.rar",
