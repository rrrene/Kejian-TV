        ...
        function _initDiv(){
          ...
          if (defaults.maskable){
            ...
            divMask.css({
              ...
              "top":  "0px",
              "left": "0px",
              "width": ($(window).width()>$(document).width())?$(window).width():((jQuery.browser.msie)?$(document).width()-21:$(document).width()) + "px",
              "height": ($(window).height()>$(document).height())?$(window).height():((jQuery.browser.msie)?$(document).height()-21:$(document).height()) + "px",
              "background": "#000",
              "opacity": 0.3,
              "z-index": "8000"
            }).show();
